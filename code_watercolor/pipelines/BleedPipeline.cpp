...
#include "../spv/shaders/bilateral.comp.inl"
;

void Tutorial::BleedPipeline::create(RTG &rtg, VkRenderPass render_pass, uint32_t subpass) 
{
    ...
    { // the set4_TEXTURE layout has a single descriptor for a sampler2D used in fragment shader:
        std::array< VkDescriptorSetLayoutBinding, 4 > bindings {
            ...
            VkDescriptorSetLayoutBinding{ // control image
                .binding = 1,
                //& Maybe combined image sampler instead?
                .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, // TODO change this once we establish what a good control image is
                .descriptorCount = 1,
                .stageFlags = VK_SHADER_STAGE_COMPUTE_BIT,
            },
...
void Tutorial::BleedPipeline::destroy(RTG &rtg)
{
