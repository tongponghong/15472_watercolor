...
#include "../spv/shaders/stamps.vert.inl"
;

static uint32_t frag_code[] = 
#include "../spv/shaders/stamps.frag.inl"
;


void Tutorial::DrawPipeline::create(RTG &rtg, 
...
void Tutorial::DrawPipeline::destroy(RTG &rtg)
{
