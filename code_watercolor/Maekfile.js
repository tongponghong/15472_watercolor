...
const gen_objs = [
	...
	maek.CPP('VertexTypes/PosColVertex.cpp'),
	maek.CPP('VertexTypes/PosNorTexVertex.cpp'),
	maek.CPP('VertexTypes/PosNorTanTexVertex.cpp'),
	
	maek.CPP('helperlibs/stb_image_lib/imageReader.cpp'),
	maek.CPP('helperlibs/S72_loader/S72.cpp'),
